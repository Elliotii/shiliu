...
## 6. Durable Research / Knowledge（约 1 分钟）

打开 `/research`：

1. 展示任务、Artifact、Fact/Topic Page 的版本与 provenance。
2. 展示人工确认、revalidation、冲突或 stale boundary。
3. 展示 Personal Workspace/Personalization 只消费明确用户状态，不自动创造偏好。
...
最终以 `POST_V5_REAL_CORPUS_ONBOARDING_REPORT.md` 的 redacted runtime counts 和
Independent Reviewer verdict 收尾。
