...
from shiliu.ask.trust import ClaimVerifierBatch, ClaimVerifierVerdict
...
class _CompatibilityClaimVerifier:
    enabled = True
    ...
    def verify(self, claims):
        return ClaimVerifierBatch(
            ...
            verifier_reference="v4-deep-deterministic-test-fake",
        )
...
def test_fake_clock_enforces_search_cutoff_and_answer_deadline(app_paths) -> None:
    ...
    answer_service.finalizer.claim_verifier = _CompatibilityClaimVerifier()
    ...
    repair_service.finalizer.claim_verifier = _CompatibilityClaimVerifier()
...
def test_deep_output_budget_failure_uses_shared_bounded_recovery(
    ...
    service.finalizer.claim_verifier = _CompatibilityClaimVerifier()
