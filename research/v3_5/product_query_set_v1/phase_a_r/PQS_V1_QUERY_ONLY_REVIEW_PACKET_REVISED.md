# Product Query Set v1 — Revised Query-only Review Packet

This packet contains query wording and traceable human-source information only. It intentionally omits answerability, target video, subtitle, Gold, search output, and expected system performance.
...
- Query Family: comparison_or_tradeoff
- Multi-aspect: false
- Possible Duplicate: None marked
- Stress-set Overlap: false
...
- Query Family: decision_or_troubleshooting
- Multi-aspect: false
- Possible Duplicate: None marked
- Stress-set Overlap: false
...
- Query Family: evaluation_or_quality
- Multi-aspect: false
- Possible Duplicate: None marked
- Stress-set Overlap: false
...
- Query Family: how_to_or_process
- Multi-aspect: false
- Possible Duplicate: None marked
- Stress-set Overlap: false
...
- Query Family: natural_multi_aspect
- Multi-aspect: true
- Possible Duplicate: None marked
- Stress-set Overlap: false
